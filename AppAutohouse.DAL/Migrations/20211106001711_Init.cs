    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Audi is the most prominent car brand for designing the best car interiors, with easy and accessible controls. Its MMI infotainment system is among the best available amongst the other brands. This car brand has the biggest vehicle line ups from being super-mini to being supra huge with the best available diesel and hybrid engines making it prominent for road racing.", "https://cdn.freelogovectors.net/wp-content/uploads/2016/12/audi-logo.png", "Audi" });

            migrationBuilder.InsertData(
                table: "Brands",
                columns: new[] { "Id", "Description", "Logo", "Name" },
                values: new object[] { 2, "With a wide range of innovative vehicle model, this car brand is known for its reliability and luxury status. This automobile company has serves its customers with luxurious piloting on the roads, while making sure that comfort has been served, from its passenger vehicles to its SUV, it will always be a great ride.", "https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/BMW.svg/2048px-BMW.svg.png", "BMW" });

            migrationBuilder.InsertData(
                table: "Brands",
                columns: new[] { "Id", "Description", "Logo", "Name" },
                values: new object[] { 3, "This car brand is attentive enough with it comes to detailing of their model, each model is well detailed with the best technological features as well as well-equipped model design. This car brand is the most stylish and comfortable amongst the other car brands in terms of its design and affordability with a favourable service cost.", "https://cdn.motor1.com/images/mgl/pqj8V/s3/logo-story-volkswagen.webp", "Volkswagen" });

            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "BrandId", "EngineSize", "EngineType", "Model", "Photo", "Price", "Year" },
                values: new object[] { 1, 1, 2.2000000000000002, 0, "A6", null, 8500, 2008 });

            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "BrandId", "EngineSize", "EngineType", "Model", "Photo", "Price", "Year" },
                values: new object[] { 2, 1, 2.5, 1, "A8", null, 13500, 2010 });

            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "BrandId", "EngineSize", "EngineType", "Model", "Photo", "Price", "Year" },
                values: new object[] { 3, 2, 3.2000000000000002, 1, "X6", null, 20500, 2020 });

            migrationBuilder.InsertData(
                table: "Requests",
                columns: new[] { "Id", "CarId", "Name", "PhoneNumber", "RequestState", "Surname" },
                values: new object[] { 1, 1, "Yuliya", "+375(29)119-97-19", 0, "Babuk" });
